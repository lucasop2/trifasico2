...
function caso1() {
  ...
  document.getElementById("iap").innerText = "corrente a: " + ia.real.toFixed(3) + "  j" + ia.imag.toFixed(3);
  document.getElementById("ibp").innerText = "corrente b: " + ib.real.toFixed(3) + "  j" + ib.imag.toFixed(3);
  document.getElementById("icp").innerText = "corrente c: " + ic.real.toFixed(3) + "  j" + ic.imag.toFixed(3);


  if (triangulo.checked) {

    document.getElementById("linhaa").innerText = "tenção de linha e de fase va: " + vanret.magnitude.toFixed(3) + " <" + vanret.angle.toFixed(3);
    document.getElementById("linhab").innerText = "tenção de linha e de fase vb: " + vbnret.magnitude.toFixed(3) + " <" + vbnret.angle.toFixed(3);
    document.getElementById("linhac").innerText = "tenção de linha e de fase vc: " + vcnret.magnitude.toFixed(3) + " <" + vcnret.angle.toFixed(3);

    document.getElementById("linhaap").innerText = "tenção de linha e de fase va: " + VAN.real.toFixed(3) + "  j" + VAN.imag.toFixed(3);
    document.getElementById("linhabp").innerText = "tenção de linha e de fase vb: " + VBN.real.toFixed(3) + "  j" + VBN.imag.toFixed(3);
    document.getElementById("linhacp").innerText = "tençao de linha e de fase vc: " + VCN.real.toFixed(3) + "  j" + VCN.imag.toFixed(3);


    document.getElementById("fasea").innerText = "za em estrela: " + zap.magnitude.toFixed(3) + " <" + zap.angle.toFixed(3);
    document.getElementById("faseb").innerText = "zb em estrela: " + zbp.magnitude.toFixed(3) + " <" + zbp.angle.toFixed(3);
    document.getElementById("fasec").innerText = "zc em estrela: " + zcp.magnitude.toFixed(3) + " <" + zcp.angle.toFixed(3);

    document.getElementById("faseap").innerText = "za em estrela: " + za.real.toFixed(3) + "  j" + za.imag.toFixed(3);
    document.getElementById("fasebp").innerText = "zb em estrela: " + zb.real.toFixed(3) + "  j" + zb.imag.toFixed(3);
    document.getElementById("fasecp").innerText = "zc em estrela: " + zc.real.toFixed(3) + "  j" + zc.imag.toFixed(3);

  }
  else {
    document.getElementById("linhaa").innerText = "tenção de linha vab: " + vanret.magnitude.toFixed(3) + " <" + vanret.angle.toFixed(3);
    document.getElementById("linhab").innerText = "tenção de linha vbc: " + vbnret.magnitude.toFixed(3) + " <" + vbnret.angle.toFixed(3);
    document.getElementById("linhac").innerText = "tenção de linha vca: " + vcnret.magnitude.toFixed(3) + " <" + vcnret.angle.toFixed(3);

    document.getElementById("linhaap").innerText = "tenção de linha vab: " + VAN.real.toFixed(3) + "  j" + VAN.imag.toFixed(3);
    document.getElementById("linhabp").innerText = "tenção de linha vbc: " + VBN.real.toFixed(3) + "  j" + VBN.imag.toFixed(3);
    document.getElementById("linhacp").innerText = "tençao de linha vca: " + VCN.real.toFixed(3) + "  j" + VCN.imag.toFixed(3);
    ...
    document.getElementById("faseap").innerText = "tenção de fase va: " + vcargaA.real.toFixed(3) + "  j" + vcargaA.imag.toFixed(3);
    document.getElementById("fasebp").innerText = "tenção de fase vb: " + vcargab.real.toFixed(3) + "  j" + vcargab.imag.toFixed(3);
    document.getElementById("fasecp").innerText = "tençao de fase vc: " + vcargac.real.toFixed(3) + "  j" + vcargac.imag.toFixed(3);
  }
